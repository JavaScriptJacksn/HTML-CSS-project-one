...
- Returning Visitor Goals:
    - As a Returning Visitor, I want to be able to easily navigate to the sign-up page and easily provide my details for the membership application (As it is usually not the first time viewing that visitors choose to sign up).
...
- Imagery
    ...
    - I also added an overlay to the hero image of black colour with an opacity of 0.65 to decrease its focus and shift its colour palette lower to fit with the rest of the site.
...
- First Time Visitor Goals:
    ...
    - As a First Time Visitor, I want to be able to see the names and specialties of the staff running the gym to see if they are indeed experienced and of value to the gym’s members.
        - The information is presented aesthetically and easily both after a short scroll or clicking the main ready for war call to action.
- Returning Visitor Goals:
...
- Firefox was primarily use for box model and css styling testing, whereas Chrome was used mostly for testing for responsiveness. However both were used for each task interchangeably at times.
- Flexbox proved a learning curve, however with the testing processes I used all issues were resolved and much was learnt.
- Friends and family members were asked to review the website on their different devices throughout and at the end of the development process.
...
- After initial deployment, I found that the responsiveness changed on the live site, which was simply a syntax error that seemed to work on Gitpod live preview but not on the deployed site.
...
- The Code Institute support network for their help.
